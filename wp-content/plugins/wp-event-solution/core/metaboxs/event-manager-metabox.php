            ...
            <div class="etn-meta">
                ...
                <div class="etn-recurring-event-span etn-recurring-single-item" id="etn-recurring-event-span">
                    ...
                    <div class='floatleft event-span-days'>
                        <!-- <div class="event-span-type-holder">
                            <input type="radio" name="<?php //echo esc_attr( $key . "[span_type]" ) ;?>" id="event-span-days-single" value="single" <?php //echo esc_attr( $span_type == "single" ? "checked" : "" )?> />
                            <label for="event-span-days-single"><?php //echo esc_html__('Single day', 'eventin');?></label>
                            
                            <input type="radio" name="<?php //echo esc_attr( $key . "[span_type]" ) ;?>" id="event-span-days-multiple" value="multiple" <?php //echo esc_attr( $span_type == "multiple" ? "checked" : "" )?> />
                            <label for="event-span-days-multiple"><?php //echo esc_html__('Multiple days', 'eventin');?></label>
                        </div> -->
